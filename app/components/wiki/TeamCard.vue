<template>
  <div class="p-4 rounded-xl border border-field-border bg-field-bg-light hover:border-field-gold/20 transition-all duration-200">
...
defineProps<{ name: string; cost: string; desc: string }>()
</script>
