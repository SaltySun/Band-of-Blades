<template>
  <div class="flex items-center gap-3 p-3 rounded-xl border border-field-border bg-field-bg hover:border-field-gold/20 transition-all">
...
defineProps<{ name: string; desc: string }>()
</script>
