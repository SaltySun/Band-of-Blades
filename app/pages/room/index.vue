    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="card-archive relative" style="transform: rotate(-0.5deg);">
        ...
        <div class="space-y-4 mt-4">
          <div>
            <label class="font-mono text-[10px] text-field-ink/70 tracking-wider uppercase block mb-1">战役代号</label>
            <input v-model="newRoom.name" class="input-paper w-full" placeholder="例如：夏日余烬" />
          </div>
          <div>
            <label class="font-mono text-[10px] text-field-ink/70 tracking-wider uppercase block mb-1">战役类型</label>
      ...
      <div class="card-archive relative" style="transform: rotate(0.5deg);">
        ...
        <div class="mt-4">
          <label class="font-mono text-[10px] text-field-ink/70 tracking-wider uppercase block mb-1">房间识别码</label>
          <input
            v-model="joinCode"
            placeholder="██████"
    ...
    <div v-if="result" class="card-archive max-w-lg mx-auto relative" style="transform: rotate(-0.3deg);">
      ...
      <div class="space-y-3 text-sm mt-4">
        <div class="flex items-center gap-3">
          <span class="font-mono text-[10px] text-field-ink/70 tracking-wider uppercase w-20">房间码</span>
          <span class="font-mono text-xl text-field-ink tracking-widest">{{ result.roomCode }}</span>
        </div>
        <div class="flex items-center gap-3">
          <span class="font-mono text-[10px] text-field-ink/70 tracking-wider uppercase w-20">GM密钥</span>
